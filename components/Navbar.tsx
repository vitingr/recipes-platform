...
import {IoMenuOutline, IoTicketOutline, IoSettingsOutline, IoStorefrontOutline, IoAdd, IoHomeOutline } from 'react-icons/io5'
          ...
          <div className='z-20 fixed right-0 bg-[#fff] shadow-md h-[650px] w-[350px] border border-[#f7f7f7] translate-y-2 transition-all rounded-lg sm:mt-[700px] mt-[650px] lg:left-[64%]'>
            ...
            <div className='p-10 gap-8 w-full flex flex-col'>
              ...
              {data.getUser.partner ? (
                ...
                <Link href="/profile/partner" className='flex w-full justify-between items-center gap-8 cursor-pointer'>
                  <RiShakeHandsLine size={30} className="gray-icon" />
                  <h3 className='text-[#717171] w-full text-lg'>Quero ser Parceiro</h3>
                </Link>
              )}
