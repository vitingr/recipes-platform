  ...
  return (
    <div className="shadow-sm shadow-neutral-400 w-[275px] h-[300px] rounded-xl">
      <div
        ...
        className="w-full h-[100px] bg-cover bg-no-repeat rounded-t-xl bg-center"
      ></div>
      <div className="p-4">
        ...
        <div className="w-full flex gap-1 justify-center mt-2 items-center">
          ...
          <span className="text-sm">{recipe.qtdLikes || "0"}</span>
        </div>
        <p className="text-center text-sm text-[#717171] mt-6">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente
          molestiae reprehenderit earum nisi
        </p>
        <Link
          href={`/recipe/${recipe.id}`}
          className="w-full flex justify-center mt-6 text-sm cursor-pointer text-[#f1656a]"
        >
          Ver receita
        </Link>
      </div>
